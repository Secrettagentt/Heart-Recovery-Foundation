...
const heroArea = document.getElementById('carouselExampleControlsNoTouching');
let slideIndex = 0;

function slideBackground() {
  const previousIndex = (slideIndex - 1 + 10) % 10;
  heroArea.classList.remove(`carousel-slide-${previousIndex}`);
  heroArea.classList.add(`carousel-slide-${slideIndex}`);
  slideIndex = (slideIndex + 1) % 10;
}
...
(function ($) {
    ...
    $("#play-video").on("click", function (e) {
        ...
        $("#video-overlay").append('<video width="560" height="315" controls><source src="assets/images/gallery/hands on heart.mp4" type="video/mp4"></video>');
    });
